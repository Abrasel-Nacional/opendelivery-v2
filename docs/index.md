...
<div class="landing-page">
 ...
 <p class="hero__lede">
 Open Delivery define como plataformas de pedido, sistemas de gestão e operações logísticas se comunicam — do pedido ao salão — sob um único padrão, sem integrações ponto a ponto.
 </p>
