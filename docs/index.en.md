...
<div class="landing-page">
 ...
 <span class="hero__pill">Open protocol</span>
 </div>

 <h1 class="hero__title">
 The universal language<br>
 of <span class="hero__title-accent">food service</span>
 </h1>

 <p class="hero__lede">
 Open Delivery defines how ordering platforms, management systems, and logistics operations communicate — from the order to the dining room — on one standard, without point-to-point integrations.
 </p>
 ...
 <span class="hero-stack__name">Guide</span>
 <span class="hero-stack__desc">Concepts and paths</span>
 </a>
 <a href="protocol/principles/" class="hero-stack__card hero-stack__card--2">
 <span class="hero-stack__step">02</span>
 <span class="hero-stack__name">Protocol</span>
 <span class="hero-stack__desc">Concepts and flows</span>
 </a>
 ...
 <span class="hero-stack__desc">API Spec</span>
 </a>
 </div>
 </div>
 </div>
 ...
 V2 is in an ecosystem validation period: company review and implementation pilots.
 A stable release will be published only after that phase. V1 remains active during the transition.
 <a href="guide/changelog/#v200-rc-july-2026">Learn more</a>
 </span>
 </div>
 ...
 <p>Open Delivery is an <strong>interoperability protocol</strong> with an API Spec. Documentation separates onboarding, domain, and implementation.</p>
 </div>
 ...
 <h3>Protocol</h3>
 <p>Domain: flows, status, events, and responsibilities per capability — in human language.</p>
 </a>
 <a href="reference/" class="layer-card">
 <span class="layer-card__step">3</span>
 <h3>API reference</h3>
 <p>API Spec (REST/HTTP): endpoints, schemas, and examples.</p>
 </a>
 </div>
 ...
 <li><a href="reference/">API contract (API Spec)</a></li>
 </ul>
 </div>
 ...
 <span class="role-card__label">CRM software</span>
 <h3>Customer data, reviews, loyalty</h3>
 <p>Customer capability — relationship and intelligence, without changing kitchen operational flow.</p>
