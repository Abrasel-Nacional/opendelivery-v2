...
3. [Merchant](../protocol/merchant.md) — consumir / sincronizar catálogo conforme dono do cardápio
...
| Protocolo | [Orders](../protocol/orders.md) · [Merchant](../protocol/merchant.md) |
...
2. [Merchant](../protocol/merchant.md) — CRUD/snapshot de catálogo, services, pause
...
| Tipo | Link |
|---|---|
| Protocolo | [Merchant](../protocol/merchant.md) · [Orders](../protocol/orders.md) · [Indoor](../protocol/indoor.md) |
